...
SeisPuntos::SeisPuntos():CampoAbs(5,3)
{
	nombreMatriz = "Seis Puntos";
}
...
bool SeisPuntos::agregar(Coordenada* x1y1, Coordenada* x2y2,int p)//2-0
{
...
bool SeisPuntos::vacio()
{
	return false;
}

bool SeisPuntos::unirCamposJuego(CampoAbs*)
{
	return false;
}

bool SeisPuntos::asignarNumeroXCuadro(int num)
{
	int contador = 0;
	for (int i = 0; i < filas; i++) {
		for (int j = 0; j < columnas; j++) {
...
void SeisPuntos::pintarMatriz(int m)
{
